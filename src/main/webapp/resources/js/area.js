...
function change4(v){
    ...
    var ss=document.getElementById(s4[v]);
    with(ss){
        length = 0;
        options[0]=new Option(opt0[v],opt0[v]);
...
var s1=["politicalpartProvince","politicalpartCity","politicalpartCounty"];//三个select的name
var s2=["deputypeopleProvince","deputypeopleCity","deputypeopleCounty"];
var s3=["politicalconsultProvince","politicalconsultCity","politicalconsultCounty"];
var s4=["unitedpartProvince","unitedpartCity","unitedpartCounty"];
var opt0 = ["","",""];//初始值
