...
<div>
    <div class="content2">
        ...
        <div style="margin-top: 20px;width: 100%">
            <h2 style="padding:15px;border-bottom: 1px solid #dddddd;width: 100%;height: 80px">中国共产党党员列表</h2>
        </div>
        <div style="width:98%;margin: 0 auto">
            <table style="font-size: 14px" id="table" class="table table-hover table-bordered tbb">
                ...
                <c:forEach var="person" items="${personList}">
                    <tr>
                        <td><a href="" onclick="window.open('/person/detail2/zggcddy/${person.personId}')">查看</a></td>
...
<script>
    function previous(currentPage,pageCount) {
        if(currentPage==0)
            ...
            window.location.href="/person/zggcddy/"+currentPage;
    }
